    ...
    <div >
          ...
          <div className="flex gap-2 justify-between flex-col items-center">
            ...
            <Link to={"/captain-home"}
              className="w-full flex justify-center text-lg bg-green-600 text-white font-semibold p-2 rounded-lg mt-5"
            >
              Finish Ride
            </Link>

            <p className='text-gray-500 text-xs mt-10 text-center'>Click of on finish ride, if you recieved the payment.</p>
