        ...
        <div className="mt-6 w-full">
          ...
          >
            <input
              ...
              className="bg-[#eee] px-6 py-4 font-mono text-lg rounded-lg w-full mt-3 text-center"
            />
            <Link
              to={"/captain-riding"}
            ...
            <button
              ...
              className="w-full bg-red-500 text-white text-lg font-semibold p-2 rounded-lg mt-1"
            >
              Cancel Ride
            </button>
          </form>
